...
tileMeasurer.onselection(function(coordA, coordB, regWidth, regHeight) {
	...
	measurementOut(`Coordinates:<br>&#9;X: ${measuredXCoords},<br>&#9;Y: ${measuredYCoords}Tiles:<br>&#9;X: ${measuredXTiles},<br>&#9;Y: ${measuredYTiles}<br>Chars:<br>&#9;X: ${measuredXChars},<br>&#9;Y: ${measuredYChars}`)
});
